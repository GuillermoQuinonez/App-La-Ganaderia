...
/**
 * Esta clase contiene una ventana en donde se pide al usuario la informaci�n necesaria para la validaci�n de la cuenta (usuario y contrase�a) y poder acceder al men� del programa La Ganaderia. Adem�s
 * contiene un bot�n que permite ingresar a la venana de registro de usurio
 * @file Login.java
...
public class Login extends JFrame {
	...
	public Login() {
		...
		btnIngresar.addActionListener(new ListenerLogin()); //Se implementa el Listener al bot�n
	...
	/**
	 * Esta clase interna escucha el evento de hacer click sobre el bot�n ingresar y registro. Env�a el usuario y contrase�a al m�todo de validaci�n si el se hace click en ingresar y abre el men� si coinciden, en caso contrario muestra un mensaje
	 * de error. Permite abrir la ventana de registro al dar click en el bont�n registro
	 */
	public class ListenerLogin implements ActionListener{
		@Override
		public void actionPerformed(ActionEvent arg0) {
			//Evento de bot�n ingresar
			if(arg0.getSource() == btnIngresar) {
				...
				if(tfUsuario.getText().compareTo("") == 0 || contrasena.compareTo("")== 0) {
					JOptionPane.showMessageDialog(null, "1.1 Ha dejado en blanco uno o m�s campos", "Campos vac�os", 2);
				}
				else {
					if(controlador.AutenticarIngreso(tfUsuario.getText(),contrasena) == true) {
						...
						JOptionPane.showMessageDialog(null, "1.2 El usuario y/o la contrase�a no coinciden", "Error de validaci�n", 0);
						tfUsuario.setText("");
