...
/**
 * Registro es una ventana de la GUI que permite ingresar la informaci�n requerida para un usuario y guardarla en los registros para crear un nuevo usuario
 * @file Registros.java
...
public class Registro extends JFrame {
	...
	/**
	 * ListenerRegistro es una clase interna que implementa un ActionListener que escucha los eventos de los botones Registrarme y Regresar al sobrescribir el m�todo actionPerformed. Verifica que no existan campos de texto en blanco, si esto ocurre llama al m�todo
	 * que permite crear un nuevo usuario y persistir la informaci�n, despliega un mensaje de confirmaci�n y regresa a la ventana de ingreso
	 */
			...
			if(arg0.getSource() == btnRegistrarme) {
				...
				if(tfNombre.getText().compareTo("") == 0 || tfUsuario.getText().compareTo("") == 0 || password.compareTo("") == 0 || password2.compareTo("") == 0|| tfUsuario.getText().compareTo("") == 0|| tfDireccion.getText().compareTo("") == 0|| tfNombreGanaderia.getText().compareTo("") == 0 || tfDireccionGanaderia.getText().compareTo("") == 0 || tfTelefono.getText().compareTo("") == 0) {
					...
					if(password.equals(password2)) {
						...
						JOptionPane.showMessageDialog(null, nombre + " ahora est� registrado", "Registrado", 1);
						...
						JOptionPane.showMessageDialog(null, "No se pudo validar la contrase�a", "Error", 0);
						tfPassword.setText("");
						tfPassword2.setText("");
					}
				}
